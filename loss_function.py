...
class DiscriminativeLoss(_Loss):
    ...
    def __init__(self, num_classes = 10, dim = 30, delta_var=0.5, delta_dist=1.5,
    ...
    def forward(self, input, target, fc):
        return self._discriminative_loss(input, target, fc)

    def _discriminative_loss(self, input, target, fc):
